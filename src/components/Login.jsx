    ...
    <div className="container" style={{ maxWidth: '600px', marginTop: '100px', marginBottom: '100px' }}>
      <div style={{ padding: '60px', border: '1px solid var(--text-ink)', backgroundColor: 'white', boxShadow: '15px 15px 0px var(--silver-accent)' }}>
        <header style={{ textAlign: 'center', marginBottom: '40px' }}>
          <h1 className="h-large" style={{ margin: 0, letterSpacing: '1px' }}>SIGN IN</h1>
          <p style={{ fontFamily: 'var(--font-main)', color: '#666', fontSize: '13px', marginTop: '10px' }}>
        ...
        <div style={{ position: 'relative', textAlign: 'center', margin: '30px 0' }}>
          <hr style={{ border: 'none', borderTop: '1px solid var(--silver-accent)' }} />
          <span style={{ position: 'absolute', top: '-10px', left: '50%', transform: 'translateX(-50%)', backgroundColor: 'white', padding: '0 15px', color: '#666', fontSize: '11px', fontFamily: 'var(--font-sans)', fontWeight: 700 }}>OR</span>
        </div>
        ...
        <button 
          ...
          style={{ width: '100%', backgroundColor: 'white', color: 'var(--text-ink)', border: '1px solid var(--text-ink)', marginBottom: '30px' }}
        >
          <span style={{ marginRight: '10px' }}>G</span> CONTINUE WITH GOOGLE
        </button>
        
        <footer style={{ textAlign: 'center', paddingTop: '30px', borderTop: '1px solid var(--silver-accent)' }}>
          <p style={{ fontFamily: 'var(--font-sans)', fontSize: '11px', color: '#666', fontWeight: 600 }}>
            NOT A SUBSCRIBER? <Link to="/signup" style={{ color: 'var(--text-ink)', textDecoration: 'underline' }}>JOIN THE GAZETTE TODAY</Link>
          </p>
        </footer>
      </div>
    </div>
