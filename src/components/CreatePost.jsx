      ...
      <div className="editor-layout">
        ...
        <div className="editor-panel">
          <header style={{ marginBottom: '40px' }}>
            <h1 className="h-large" style={{ margin: 0 }}>NEW ARTICLE</h1>
            <div style={{ fontSize: '11px', fontFamily: 'var(--font-sans)', color: '#666', marginTop: '5px' }}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="editor-field">
              ...
              <textarea
                className="editor-input"
                style={{ fontSize: '1rem', border: '1px solid var(--silver-accent)', padding: '10px' }}
                value={excerpt}
            ...
            <div style={{ display: 'flex', gap: '20px', marginTop: '40px' }}>
              ...
              <button 
                ...
                className="btn-heritage"
                style={{ backgroundColor: 'white', color: 'var(--text-ink)', border: '1px solid var(--text-ink)', flex: 1 }}
              >
                CANCEL
              </button>
            </div>
        ...
        <div className="preview-panel">
          <div style={{ maxWidth: '700px', margin: '0 auto' }}>
            <div style={{ borderBottom: '1px solid black', paddingBottom: '5px', marginBottom: '30px', textAlign: 'center' }}>
              <span className="editor-label">Live Preview</span>
            </div>
            
            <span className="kicker" style={{ color: '#d32f2f' }}>{category}</span>
            <h1 className="h-giant">{title || 'Your Headline Will Appear Here'}</h1>
            
            <div className="byline" style={{ borderTop: '1px solid black', borderBottom: '4px double black', padding: '15px 0', marginTop: '20px' }}>
              By {userProfile?.displayName || user?.email?.split('@')[0]} • Published {new Date(publishedAt).toLocaleDateString().toUpperCase()}
            </div>

            {imagePreview && (
              <div className="media-frame" style={{ margin: '30px 0', padding: 0, border: 'none' }}>
                <img src={imagePreview} alt="Preview" style={{ width: '100%' }} />
              </div>
            )}

            <div className="body-text" style={{ fontSize: '1.2rem', marginTop: '30px', whiteSpace: 'pre-wrap' }}>
